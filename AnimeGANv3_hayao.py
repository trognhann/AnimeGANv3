        ...
        for epoch in range(start_epoch, self.epoch):
            for idx in range(steps):
                ...
                if epoch < self.init_G_epoch:
                    # Task-Switching: vary alpha even during pre-training
            ...
            if (epoch + 1) >= self.init_G_epoch:
                ...
                for i, sample_file in enumerate(val_files):
                    ...
                    val_real,test_s1, test_s0, test_m = self.sess.run([self.val_real,self.val_generated,self.val_generated_s,self.val_generated_m], feed_dict=val_feed)
